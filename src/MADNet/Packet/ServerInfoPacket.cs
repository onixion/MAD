...
namespace MadNet
{
    public class ServerInfoPacket : Packet
    {
        ...
        public ServerInfoPacket(NetworkStream stream, AES aes, byte[] serverHeader, byte[] serverVersion, byte[] fingerprint)
            : base(stream, aes, 5)
        {
