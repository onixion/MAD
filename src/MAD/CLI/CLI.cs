...
namespace MAD.CLICore
{
    public class CLI : CLIFramework
    {
            ...
            :base()
        {
            ...
            commands.Add(new CommandOptions("node stop", typeof(JobSystemStopNodeCommand), new object[] { js }));
            ...
            */
            ...
            // Database commands
            commands.Add(new CommandOptions("db", typeof(DBShowTables), new object[] { db }));

            commands.Add(new CommandOptions("db jobs", typeof(DBJobs), new object[] { db }));
            commands.Add(new CommandOptions("db jobs delete all", typeof(DBJobsDelAll), new object[] { db }));
            
            commands.Add(new CommandOptions("db summary", typeof(DBSumShow), new object[] { db }));
            commands.Add(new CommandOptions("db summary create", typeof(DBSumCreate), new object[] { db }));
            commands.Add(new CommandOptions("db summary delete", typeof(DBSumDel), new object[] { db }));
            commands.Add(new CommandOptions("db summary delete all", typeof(DBSumDelAll), new object[] { db }));
            
            commands.Add(new CommandOptions("db memo add", typeof(DBMemoAdd), new object[] { js, db }));
            commands.Add(new CommandOptions("db memo show", typeof(DBMemoShow), new object[] { js, db }));
